...
public class OperateStockTest {
	...
	public void setUp() {
		...
		skuStockService = context.getBean(ISkuStockService.class);
	}
	...
	public void testinvokesku() {
		...
		logger.info("---------testinvokesku result data:-------" + JSONConverter.toJson(stockProResult));
	}
