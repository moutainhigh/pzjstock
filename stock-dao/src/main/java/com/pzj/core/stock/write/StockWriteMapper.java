...
public interface StockWriteMapper {
	 ...
	 * @return
	 */
	int updateStockNum(@Param(value = "stockId") long stockId, @Param(value = "usedNum") int usedNum,
			@Param(value = "remainNum") int remainNum);
	 ...
	 * @return int 影响行数
	 */
	int updateStockUpperLimitByStockRuleId(@Param(value = "ruleId") Long ruleId,
			@Param(value = "upperLimit") Integer upperLimit);
	 ...
	 * @return
	 */
	int updateStockLimitById(@Param(value = "id") Long id, @Param(value = "newestNum") Integer newestNum);

	List<Stock> selectStockByRuleIdDate(@Param(value = "ruleId") Long ruleId, @Param(value = "stockTime") Integer stockTime);
}