...
public interface LockRecordReadMapper {
	 ...
	 * @return
	 */
	LockRecord queryLockedRecord(@Param(value = "transactionId") String transactionId,
	 ...
	 * @return LockRecord
	 */
	List<LockRecord> queryLockRecordByUser(@Param(value = "stockIds") List<Long> stockIds,
			@Param(value = "operatorId") Long operatorId, @Param(value = "bizType") Integer bizType);
