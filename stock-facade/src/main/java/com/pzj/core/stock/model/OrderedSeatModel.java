 ...
 * 
 * @author dongchunfu
 * @version $Id: OrderedSeatVO.java, v 0.1 2016年8月2日 上午11:16:09 dongchunfu Exp $
 */
public class OrderedSeatModel implements Serializable {

    private static final long serialVersionUID = -5868187396768272828L;
    ...
    public String toString() {
        StringBuilder tostr = new StringBuilder(OrderedSeatModel.class.getSimpleName());
        tostr.append("[");
