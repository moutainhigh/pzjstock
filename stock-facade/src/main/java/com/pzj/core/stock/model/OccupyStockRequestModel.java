...
public class OccupyStockRequestModel implements java.io.Serializable {
	...
	public String toString() {
		return "OccupyStockRequestModel [transactionId=" + transactionId + ", productId=" + productId + ", stockId="
				+ stockId + ", stockNum=" + stockNum + ", userId=" + userId + ", bussinessType=" + bussinessType
				+ ", invokeOnlyId=" + invokeOnlyId + ", stockRuleId=" + stockRuleId + ", showDate=" + showDate + "]";
	}
