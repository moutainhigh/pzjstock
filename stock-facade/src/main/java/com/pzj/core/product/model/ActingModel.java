 ...
 */
public class ActingModel implements Serializable {

    private static final long serialVersionUID = 5131593952522082477L;
    ...
    public List<Long> getScreeinsIds() {
        return screeinsIds;
    }

    public void setScreeinsIds(List<Long> screeinsIds) {
        this.screeinsIds = screeinsIds;
    }

    @Override
    public String toString() {
        StringBuilder tostr = new StringBuilder(ActingModel.class.getSimpleName());
        tostr.append("[");
        ...
        tostr.append("areaIds: ").append(areaIds).append(",");
        tostr.append("screeinsIds: ").append(screeinsIds).append(",");
        tostr.append("]");
