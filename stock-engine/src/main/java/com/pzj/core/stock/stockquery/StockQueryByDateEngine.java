 ...
 */
@Component(value = "stockQueryByDateEngine")
public class StockQueryByDateEngine {
    @Autowired
    private StockReadMapper stockReadMapper;

    public ArrayList<Stock> queryStockByDate(StockQueryRequestModel model, ServiceContext context) {
    ...
    private Stock produceStock(StockQueryRequestModel model) {
        ...
        stock.setStockTime(model.getStockTimeInt());
