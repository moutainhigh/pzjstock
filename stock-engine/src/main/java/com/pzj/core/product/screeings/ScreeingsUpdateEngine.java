...
public class ScreeingsUpdateEngine {
	...
	public int updateScreeings(ScreeingsModel model, ServiceContext context) {
		...
		try {
			...
			logger.error(" copy screeings model properties to screeings error,request:{},context:{}. ", model, context,
					e);
	...
	public int deleteScreeing(Long screeingId) {
		return screeingsWriteMapper.deleteScreeingsById(screeingId);
	}
}